...
- Run the script `src/train.r` to train the classification model. This will save the model artifacts, including the preprocessing pipeline and label encoder, in the path `./model_inputs_outputs/model/artifacts/`.
...
The classifier expects the target feature at the end of the dataframe and the input features to be in the same order in both training and testing phases.
